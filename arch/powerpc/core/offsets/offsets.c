...
GEN_OFFSET_SYM(z_arch_esf_t, nia);
GEN_OFFSET_SYM(z_arch_esf_t, srr1);
GEN_OFFSET_SYM(z_arch_esf_t, lr);
GEN_OFFSET_SYM(z_arch_esf_t, ctr);
GEN_OFFSET_SYM(z_arch_esf_t, cr);
GEN_OFFSET_SYM(z_arch_esf_t, r0);
